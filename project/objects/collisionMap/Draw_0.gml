if drawSurface {
	...
	surface_copy_part(causticSurf,0,0, water.causticSurfaceOriginal,x,y,sprite_get_width(sprite_index)*image_xscale,sprite_get_height(sprite_index)*image_yscale)
	surface_set_target(causticSurf)
